...
$sql = "SELECT SELECT CFECHA AS fecha, CSERIEDOCUMENTO AS serie, CFOLIO AS folio, CIDCONCEPTODOCUMENTO AS concepto, CNETO AS importe, CIMPUESTO1 AS iva, CTOTAL AS total, CRAZONSOCIAL, CRFC, CIMPORTEEXTRA1, CREFERENCIA
