...
$sql = "SELECT CIDDOCUMENTO, CREFERENCIA, CTOTAL, CRAZONSOCIAL FROM admDocumentos  WHERE CSERIEDOCUMENTO = 'FRT-REY' AND CRAZONSOCIAL = '$razon_social' ORDER BY CIDDOCUMENTO ASC";
